...
class CaptainCookStepDataset(Dataset):
    ...
    def __init__(self, config, phase, split):
        ...
        with open('/content/drive/.shortcut-targets-by-id/1Ne50XFNHZEsQ3K0_cYI4JdBWqJm3_B7h/Mistake_Detection/error_recognition_main/annotations/step_annotations.json', 'r') as f:

            self._annotations = json.load(f)

        with open('/content/drive/.shortcut-targets-by-id/1Ne50XFNHZEsQ3K0_cYI4JdBWqJm3_B7h/Mistake_Detection/error_recognition_main/annotations/error_annotations.json', 'r') as f:
    ...
    def __getitem__(self, idx):
        ...
        assert self._backbone in [const.OMNIVORE, const.SLOWFAST, const.PERCEPTION_ENCODER], "Unsupported backbone configured"
