...
class Result:
    ...
    def __init__(
        ...
        if self.model_name is None:
            self.model_name = f"{self.task_name}_{self.variant}_{self.backbone}_{self.modality}_{self.split}_{self                  .error_category}"
    ...
    def from_dict(cls, result_dict: Dict) -> 'Result':
        result = cls(
            ...
            error_category=result_dict["error_category"] 
        )
