...
class Config(object):
    ...
    def __init__(self):
        ...
        self.segment_features_directory = "/content/drive/MyDrive/Mistake_Detection/features"


        self.ckpt_directory = "/content/drive/MyDrive/Mistake_Detection/error_recognition_main/checkpoints"
    ...
    def setup_parser(self):
        ...
        parser.add_argument('--ckpt_directory', type=str, default='/content/drive/MyDrive/Mistake_Detection/error_recognition_main/checkpoints',
