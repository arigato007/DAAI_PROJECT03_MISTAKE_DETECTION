...
### New backbone: perception_encoder
- Place features under `features/video/perception_encoder/` using the same npz naming as other backbones.
- Feature dimension (PE-Core-B16-224): 1024. Ensure `fetch_input_dim` returns 1024 for this backbone.
